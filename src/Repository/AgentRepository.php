...
class AgentRepository extends ServiceEntityRepository
{
    ...
    public function findBySpecialite()
    {
        ...
        FROM agent AS a
        JOIN mission ON a.mission_id = mission.id 
        JOIN agent_specialite ON a.id = agent_specialite.agent_id
        JOIN specialite ON agent_specialite.specialite_id = specialite.id
        WHERE mission.speciality = a.specialite");
